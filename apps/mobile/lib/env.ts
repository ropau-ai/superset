...
const envSchema = z.object({
	...
	// Relay base URL for host-service HTTP + WebSocket access (live terminal
	// stream + agent activity). Optional: when unset the Live Session screen
	// degrades to a "relay not configured" state instead of crashing.
